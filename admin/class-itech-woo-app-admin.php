 ...
 * @subpackage Itech_Woo_App/admin
 */
...
class Itech_Woo_App_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Itech_Woo_App_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Itech_Woo_App_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/itech-woo-app-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/itech-woo-app-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function Itech_Woo_App_menu() {

		//add_menu_page('Mstoreapp Mobile App', 'Mobile App', 'manage_options', 'itech-woo-app', array(&$this, 'mobile_app_notification_page'), 'dashicons-smartphone');
	...
	public function register_Itech_Woo_App_settings() {

        register_setting( 'Itech_Woo_App_settings', 'mstoreapp_api_keys' );
    ...
    public function push_notification_menu() {
      ...
      $sDir = rtrim($sDir, '/');
      $sDir = str_replace('/itech-woo-app/admin','',$sDir); // myplugin was folder name of current plugin
      $sDir = rtrim($sDir, '/');
            ...
            if ( $reference ) {
                ...
                if ( ! is_wp_error( $request ) && 200 === wp_remote_retrieve_response_code( $request ) ) {
                    ...
                    if ( 'success' == $paystack_response->data->status ) {
                        ...
                        $paystack_logger = new WC_Paystack_Plugin_Tracker( 'woo-paystack', $public_key );
    ...
    public function flutter_new_chat_message() {
        ...
        if(isset($_REQUEST['message'])) {
            ...
            if(isset($_REQUEST['vendor_id'])) {
                ...
                $tokens[] = get_user_meta($vendor_id, 'fcm_token', true);
            } else {
                $admins = get_users( [ 'role__in' => [ 'administrator' ] ] );
                foreach ( $admins as $user ) {
                    $tokens[] = get_user_meta( $user->id, 'fcm_token', true );
                }
            }
