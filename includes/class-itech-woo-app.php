...
class Itech_Woo_App {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Itech_Woo_App_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'itech-woo-app';
		$this->version = '1.0.0';
	 ...
	 *
	 * - Itech_Woo_App_Loader. Orchestrates the hooks of the plugin.
	 * - Itech_Woo_App_i18n. Defines internationalization functionality.
	 * - Itech_Woo_App_Admin. Defines all hooks for the admin area.
	 * - Itech_Woo_App_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-itech-woo-app-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-itech-woo-app-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-itech-woo-app-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-itech-woo-app-public.php';

		/**
		 * The class responsible for defining all actions that occur in the multivendor of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-itech-woo-app-multivendor.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-itech-woo-app-payments.php';

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/admin-init.php';


		$this->loader = new Itech_Woo_App_Loader();
	 ...
	 *
	 * Uses the Itech_Woo_App_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Itech_Woo_App_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Itech_Woo_App_Admin( $this->get_plugin_name(), $this->get_version() );
		...
		$this->loader->add_action('wp_ajax_itech-woo-app-notification', $plugin_admin, 'mobile_app_notification');
        $this->loader->add_action('wp_ajax_nopriv_itech-woo-app-notification', $plugin_admin, 'mobile_app_notification');

		$this->loader->add_action('admin_menu', $plugin_admin, 'Itech_Woo_App_menu');
		//$this->loader->add_action('admin_menu', $plugin_admin, 'push_notification_menu');
        $this->loader->add_action('admin_init', $plugin_admin, 'register_Itech_Woo_App_settings');
        ...
        $this->loader->add_action('wp_ajax_mstore_flutter_test', $plugin_admin, 'test');
        $this->loader->add_action('wp_ajax_nopriv_mstore_flutter_test', $plugin_admin, 'test');
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Itech_Woo_App_Public( $this->get_plugin_name(), $this->get_version() );
        ...
        $this->loader->add_action('wp_ajax_mstore_flutter-apply-vendor', $plugin_public, 'dokan_apply_for_vendor');
        $this->loader->add_action('wp_ajax_nopriv_mstore_flutter-apply-vendor', $plugin_public, 'dokan_apply_for_vendor');

        $this->loader->add_action('wp_ajax_mstore_flutter_checkout_form', $plugin_public, 'checkout_form');
        $this->loader->add_action('wp_ajax_nopriv_mstore_flutter_checkout_form', $plugin_public, 'checkout_form');
        ...
        $plugin_multivendor = new Itech_Woo_App_Multivendor( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_payments_hooks() {
		...
		$plugin_payments = new Itech_Woo_App_Payments( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Itech_Woo_App_Loader    Orchestrates the hooks of the plugin.
	 */
