 ...
 * @subpackage Itech_Woo_App/public
 */
 ...
 */
class Itech_Woo_App_Multivendor
{
    ...
    public function get_dokan_vendor_reviews($store_id){
        ...
        $args = array(
            ...
            'meta_value'     => $store_id,
            'post_status'    => 'publish',
            'posts_per_page' => (int) $_REQUEST['per_page'],
    ...
    public function get_wcfm_vendor_reviews($vendor_id){
        ...
        $_POST['orderby'] = !empty($_REQUEST['orderby']) ? $_REQUEST['orderby'] : '';
        $_POST['order'] = !empty($_REQUEST['order']) ? $_REQUEST['order'] : '';
        $_POST['status_type'] = !empty($_REQUEST['status_type']) ? $_REQUEST['status_type'] : '';
    ...
    public function get_vendor_details() {
        ...
        if(isset($_REQUEST['vendor'])) {
            ...
            $store_id = $_REQUEST['wcpv_product_vendors'];
        }
    ...
    public function pre_get_users($query) {
        ...
        } else if(isset($mstoreapp_vendor_type)) {

            $query->query_vars['meta_query'] = $this->add_meta_query( $query->query_vars['meta_query'], array(
                'key'     => 'mstoreapp_vendor_type',
                'value'   => $mstoreapp_vendor_type,
                'compare' => 'LIKE',
            ) );
        }

        unset($mstoreapp_vendor_type);
