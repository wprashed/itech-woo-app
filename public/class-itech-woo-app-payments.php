...
/**
 * The payments-facing functionality of the plugin.
 *
 * @link       https://itech-softsolutions.com/
 * @since      1.0.0
 *
 * @package    Itech_Woo_App
 * @subpackage Itech_Woo_App/payments
 */
...
class Itech_Woo_App_Payments
{
    ...
    public function verify_payment() {
        ...
        switch ($order->payment_method) {
            case 'paystack':
                ...
                break;
            case 'paytm':
                return $this->verify_paytm_transaction();
                break;
            case 'razorpay':
                return $this->verify_razorpay_transaction();
                break;
            default:
                $this->send_error();
        }
     ...
     */
    public function verify_paytm_transaction() {}

    /**
     * Verify Paystack payment.
     */
    public function verify_razorpay_transaction() {}
