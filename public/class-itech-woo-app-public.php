...
class Itech_Woo_App_Public
{
    ...
    public function keys()
    {
        ...
        $locale_cls = new Itech_Woo_App_i18nt();
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/itech-woo-app-public.css', array(), $this->version, 'all');
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/itech-woo-app-public.js', array('jquery'), $this->version, false);
